...
+ function($) {
  ...
  $.toast = function(text, style, callback) {
    ...
    show('<i><svg style="width:3rem;height:3rem;vertical-align:middle;"><use xlink:href="#icon-success1f"></use></svg></i><p class="weui-toast_content">' + (text || "已经完成") + '</p>', className);
